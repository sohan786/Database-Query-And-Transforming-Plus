...
import javax.swing.border.*;
 class AccessEditor extends JFrame implements ActionListener
{
...
ImageIcon img8=new ImageIcon("access.png");
...
l7.setBounds(0,0,1280,800);
l8.setBounds(1150,10,100,30);
l9.setBounds(300,10,600,70);
l5.setBounds(10,10,350,50);
l10.setBounds(1150,60,100,30);
l6.setBounds(1150,110,100,30);
ta.setBounds(100,100,1010,300);
b1.setBounds(100,450,150,60); b2.setBounds(280,450,150,60);l1.setBounds(450,450,150,60);l2.setBounds(620,450,150,60);l3.setBounds(790,450,150,60);l4.setBounds(960,450,150,60);
...
try
{
Connection con=(Connection)AccessConnectionok.getConnection();
...
{
AccessEditor ae=new AccessEditor();
ae.display();
}
}